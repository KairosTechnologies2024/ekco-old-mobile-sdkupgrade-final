    ...
    try {
      ...
      for (const pair of tripPairs) {
        ...
        try {
          ...
          if (gpsLogs.length >= 1) {
            const distance = gpsLogs.length >= 2 ? calculateDistance(
              gpsLogs[0].latitude,
              gpsLogs[0].longitude,
              gpsLogs[gpsLogs.length - 1].latitude,
              gpsLogs[gpsLogs.length - 1].longitude
            ) : 0;
...
<html>
  ...
  <body>
    ...
    <div class="footer">
      ...
      <p>Generated by Ekco Vehicle Guard - ©️ Kairos Technologies</p>
    </div>
  </body>
</html>
`;
  ...
  return (
    <SafeAreaView className="flex-1 bg-gray-50" edges={["left", "right", "bottom"]}>
      ...
      {/* Export Button */}
      <TouchableOpacity
        className="mx-4 mt-4 bg-green-500 rounded-xl py-3 flex-row items-center justify-center"
